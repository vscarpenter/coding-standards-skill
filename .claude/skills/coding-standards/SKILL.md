...
description: |
  ...
  "coding standards", "code quality", "best practices", "Definition of Done", "code review",
  or asks Claude to follow team conventions. This skill should be the baseline for every
  coding session — if code is being written, this skill applies.
version: 10.0.0
